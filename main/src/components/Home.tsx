...
import {Box, CardContent, Checkbox, FormControlLabel, FormGroup, SelectChangeEvent, Typography} from "@mui/material";
...
export default function Home() {
    ...
    const onSelectChange = (e:SelectChangeEvent<number>) =>{
        ...
        setCurrentAttribute(displayingAttributes.filter(a=>a.id==+e.target.value!)[0])
    }
    ...
    return (
        <>
                                ...
                                <Grid container mt={1} columns={{md: 9}}>
                                    <Grid item md={3}>
                                        <FormControlLabel control={<Checkbox color={"default"}/>}
                                                          label="AT-1"></FormControlLabel>
                                    </Grid>
                                    <Grid item md={3}>
                                        <FormControlLabel control={<Checkbox color={"default"}/>}
                                                          label="ABT-1"></FormControlLabel>
                                    </Grid>
                                    <Grid item md={3}>
                                        <FormControlLabel control={<Checkbox color={"default"}/>}
                                                          label="VISBREKING"></FormControlLabel>
                                    </Grid>
                                    <Grid item md={3}>
                                        <FormControlLabel control={<Checkbox color={"default"}/>}
                                                          label="AT-1"></FormControlLabel>
            ...
            <ReportPreviewModal open={reportPreviewOpen} handlerClose={() => setReportPreviewOpen(false)} attributes={patternAttributes}/>
        </>
    );
}